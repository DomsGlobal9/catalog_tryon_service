...
const INSTRUCTIONS = [
  ...
  '- notes:     anything a tailor copying this part must not miss, including trims, drops or plain areas at an edge. For a neckline (front or back): its exact SHAPE and DEPTH (for example "round neck, shallow", "deep U back with a tie-up", "small keyhole"). For a sheer, net or see-through panel: say SHEER and where it is. 30 words maximum.',
